...
#     system_instruction="Imagine you are the Christina Yang from Grey's Anatomy, you are in a neurodegenerative disease center and I need you to determine in 5 interactions what disease the patient may have. In order to record the symptoms, I need you to invite the patient to mention the symptom explicitly. Only spanish",
#   )
...
#     """
#     # Crear una instancia del modelo generativo para análisis
#     genai.configure(api_key=os.getenv("GEMINI_API_KEY"))
#     generation_config = {
#         "temperature": 0.7,
#         "top_p": 0.9,
#         "top_k": 40,
#         "max_output_tokens": 1024,  # Tokens limitados para enfoque
#         "response_mime_type": "text/plain",
#     }
...
#     prompt = f"Basado en la siguiente conversación, determina el {analysis_target} del paciente.\n\n{conversation_text}"
